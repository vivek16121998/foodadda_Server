...
public class UsersDTO {
	...
	@NotNull(message = "{User.INVALID_USERNAME_FORMAT}")
	@Pattern(regexp = "[A-Za-z]+( [A-Za-z]+)*", message = "{User.INVALID_USERNAME_FORMAT}")
	private String userName;
	@NotNull(message = "{User.INVALID_CONTACT_NUMBER_FORMAT}")
	@Pattern(regexp = "[6-9][0-9]{9}", message = "{User.INVALID_CONTACT_NUMBER_FORMAT}")
	private String contactNumber;
	@NotNull(message = "{User.INVALID_EMAIL_ID_FORMAT}")
	@Pattern(regexp = "[A-Za-z]+[0-9]*[A-Za-z]*@[A-Za-z]+[.](com|in)", message = "{User.INVALID_EMAIL_ID_FORMAT}")
	private String emailId;
	@NotNull(message = "{User.PASSWORD_ABSENT}")
